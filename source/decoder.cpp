...
std::optional<DecodedInst> Decoder::decode(uint32_t raw_instr) {
    ...
    std::cout << "DECODE: raw=0x" << std::hex << raw_instr
              << " opcode=0x" << (int)instr.opcode
              << " rd=x" << std::dec << (int)instr.rd
              << " rs1=x" << (int)instr.rs1
              << " imm=" << std::hex << "?"
              << std::endl;
...
const char* Decoder::funct3_to_string(Funct3 f3) {
    switch (f3) {
        ...
        case FUNCT3_ADD_SUB: return "ADD/SUB/ADDI";
        case FUNCT3_SLL:     return "SLL/SLLI";
        case FUNCT3_SLT:     return "SLT/SLTI";
        case FUNCT3_SLTU:    return "SLTU/SLTIU";
        case FUNCT3_XOR:     return "XOR/XORI";
        case FUNCT3_SRL_SRA: return "SRL/SRA/SRLI/SRAI";
        case FUNCT3_OR:      return "OR/ORI";
        case FUNCT3_AND:     return "AND/ANDI";
        default:             return "UNKNOWN";
    }
}
...
const char* Decoder::instr_type_to_string(InstrType type) {
    switch (type) {
        case InstrType::R: return "R-type";
        case InstrType::I: return "I-type";
        case InstrType::S: return "S-type";
        case InstrType::B: return "B-type";
        case InstrType::U: return "U-type";
        case InstrType::J: return "J-type";
        default:           return "UNKNOWN";
    }
}
